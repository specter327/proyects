...
def identify_modules() -> List[ControllerDescriptor]:
...
available_controllers = identify_modules()


# Code API
__all__ = ["ControllerDescriptor", "identify_modules", "available_controllers"]