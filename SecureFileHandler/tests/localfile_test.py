# Library import
from securefilehandler import SecureFileHandler, LocalFileHandler
import subprocess

# Test execution
# Create the virtual file
print("[*] Creating the virtual file...")
virtual_file = LocalFileHandler(
    filepath="./file_probe.encrypted",
    mode='rb+'
)
...
print("==========")
print("Raw content:")
print(subprocess.getoutput("cat ./file_probe.encrypted", errors="ignore"))
